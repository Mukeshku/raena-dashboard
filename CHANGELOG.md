...
## [1.3.0] 2021-05-17
### Bug fixing
- We've change all class components to function ones, so now, Paper Summary React accepts hooks
### Major style changes
### Deleted components
### Added components
...
- We've renamed `src/layouts/Summary/Summary.jsx` to `src/layouts/Admin.jsx`
...
- We've renamed `src/views/Summary/Summary.jsx` to `src/views/Summary.jsx`
...
- Added design from Paper Summary 2 by Creative Tim
